import{s as r}from"./supabase-B9cvm4hE.js";/* empty css              */let d="todas",o=null,i=[];async function v(){try{const{data:{user:e}}=await r.auth.getUser();if(!e)return console.error("Usuário não autenticado"),[];const{data:a,error:t}=await r.from("propostas").select(`
        *,
        anuncios (
          titulo,
          autora,
